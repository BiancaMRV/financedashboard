    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-x-6 mt-9">
        ...
        <div className="bg-gray-900 p-6 rounded-2xl">
          <h1 className="text-gray-400 text-sm"> Portfolio Crypto </h1>
          <p className="text-2xl text-white mt-2"> $32,313.00</p>
          <p className="text-sm text-green-500 mt-2"> +5.2% (24h) </p>
        </div>
        <div className="bg-gray-900 p-6 rounded-2xl">
          <h1 className="text-gray-400 text-sm"> Lucro Total</h1>
          <p className="text-2xl text-white mt-2"> $8,342.00</p>
          <p className="text-sm text-green-500 mt-2"> +37,1%(desde o inicio)</p>
        </div>
        {/* Despesas Mensais */}
        <div className="bg-gray-900 p-6 rounded-2xl">
          <h1 className="text-gray-400 text-sm">Mercado Geral</h1>
          <p className="text-2xl text-white mt-2"> $2.17T </p>
          <p className="text-sm text-green-500 mt-2"> +3,7% (24h)</p>
        </div>
      </div>
