    ...
    <div className="flex-1">
      ...
      <div className="grid grid-cols-3 mt-8 gap-4 ">
        ...
        <div className="bg-gray-900 p-6 rounded-2xl col-span-2">
          ...
          <p className="text-gray-500 text-sm mb-4">Últimos 12 meses</p>
